...
get_article_urls <- function(url, p = NULL) {
  ...
  years <- paste0(c("2017", "2018", "2019", "2023", "2024"), collapse = "|")
...
# save(article_urls, file = "data/article_urls.RData")
# load("data/article_urls.RData")
...
faz2 <- tibble(do.call(rbind, faz_full))
write_csv(faz2, "data/faz_full2.csv")
