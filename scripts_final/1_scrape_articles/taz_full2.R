...
sitemaps <- sitemaps[grepl("2017|2018|2019|2023|2024", sitemaps)]
...
patterns <- c(
  ...
  '//p[@class="article even BrotO lastInCol"]',
  '//p[@class="article odd Brot"]',
  '//p[@class="article even Brot"]',
  '//p[@class="article last odd Brot"]',
  '//p[@class="article last even Brot"]'
)
...
taz_full <- tibble(do.call(bind_rows, taz_full))
